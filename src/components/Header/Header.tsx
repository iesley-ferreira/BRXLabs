...
const Header = () => {
  ...
  return (
    <header className="p-4  relative">
      <nav className="container mx-auto flex items-center justify-between relative z-20">
        {/* Desktop: links à esquerda */}
        <div className="hidden md:flex w-full gap-8 justify-evenly">
        ...
        {/* Logo central (mostrada na versão mobile se o menu estiver fechado) */}
        {!mobileMenuOpen && (
      ...
      {/* Mobile Menu Overlay */}
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 w-full  z-20 md:hidden">
