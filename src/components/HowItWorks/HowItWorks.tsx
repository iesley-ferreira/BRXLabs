        ...
        <div className="flex flex-wrap -m-4">
          <div className="w-full md:w-1/3 p-4">
            <div className="md:max-w-xs mx-auto text-center">
              ...
              <h3 className="font-heading font-medium text-xl text-[#956afa] mb-2">
                Entendemos seu negócio
              </h3>
              <p className="text-gray-400">
                Analisamos seus processos, identificamos desafios e mapeamos oportunidades de
                automação para maximizar a eficiência.
              </p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/3 p-4">
            <div className="md:max-w-xs mx-auto text-center">
              ...
              <h3 className="font-heading font-medium text-xl text-[#956afa] mb-2">
                Criamos uma estratégia sob medida
              </h3>
              <p className="text-gray-400">
                Planejamos soluções inteligentes e personalizadas, garantindo que a automação
          ...
          <div className="w-full md:w-1/3 p-4">
            <div className="md:max-w-xs mx-auto text-center">
              ...
              <h3 className="font-heading font-medium text-xl text-[#956afa] mb-2">
                Executamos e otimizamos
              </h3>
              <p className="text-gray-400">
                Colocamos tudo em prática, implementamos a automação e acompanhamos os resultados
