...
const CreateUserModal: React.FC<CreateUserModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch(`${API_URL}/webhook/admin/criar-usuario`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
        body: JSON.stringify(formData), // já inclui todos os campos necessários
      });
  ...
  return (
    // <div className="fixed inset-0 bg-[#000000b0] flex items-center justify-center">
